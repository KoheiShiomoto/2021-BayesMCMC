...
def get_args():
    ...
    psr.add_argument('-iPop','--inPopFileName', default='popData_1104_1110_internet.csv', help='File name of Input Time Series Population data')  
    psr.add_argument('-iXi','--inXiFileName', default='xiData_internet_1104_1110.csv', help='File name of Input Time Series Xi data')  
...
if __name__ == '__main__':
    ...
    inXiFileName = output+"/"+args.inXiFileName
    #
    pjName = args.pjName
    ...
    engine = milanoTrafficDB.milanoTrafficDB(csvInputFileName=inTrfMtxFileName,
                                             ts_type = "Traffic",
                                             pjName = pjName,
                                             t0 = t0,
                                             t1 = t1
    ...
    engine.show()
    engine.plot_gh(explanation_xlabel = "Time",
                   explanation_ylabel = "Traffic volume")
    engine.gen_tex(explanation1 = 'time series of traffic volume',
                   explanation2 = '(period: from '+t0str+' to '+t1str+')')
    # engine.plot_ghByCity()


    engine = milanoTrafficDB.milanoTrafficDB(csvInputFileName=inPopFileName,
                                             ts_type = "Population",
                                             pjName = pjName,
                                             t0 = t0,
                                             t1 = t1
    ...
    engine = milanoTrafficDB.simpleTSDB(csvInputFileName=inXiFileName,
                                        ts_type = "ActivityFactor",
                                        pjName = pjName,
                                        t0 = t0,
                                        t1 = t1
    )
    engine.show()
    engine.plot_gh(explanation_xlabel = "Time",
                   explanation_ylabel = "Activity Factor")
    engine.gen_tex(explanation1 = 'time series of activity factor',
                   explanation2 = '(period: from '+t0str+' to '+t1str+')')
